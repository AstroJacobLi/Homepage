...
<script type="math/tex; mode=display"> N(M)dM</script>
...
=\frac{1}{\sqrt{\pi}}\left(1+{\frac{n}{3}}\right)\frac{\bar \rho}{M^2}\left(\frac{M}{M^\*}\right)^{{\left(3+n\right)/6}}\exp\left(-\left({\frac{M}{M^{*}}}\right)^{{\left(3+n\right)/3}}\right)dM
